export const abi2 = [
  ...
  { inputs: [], name: "ClaimRefundNotReady", type: "error" },
  { inputs: [], name: "ConfigAlreadySet", type: "error" },
  { inputs: [], name: "ConfigNotSet", type: "error" },
  { inputs: [], name: "InvalidAmountInWei", type: "error" },
  ...
  { inputs: [], name: "PurchaseLimitReached", type: "error" },
  ...
  { inputs: [], name: "UserAlreadyClaimed", type: "error" },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint32", name: "qty", type: "uint32" },
      {
        indexed: false,
  ...
  },
  {
    ...
    outputs: [{ internalType: "uint32", name: "claimable", type: "uint32" }],
    stateMutability: "view",
    type: "function",
  },
  {
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "uint216", name: "limitInWei", type: "uint216" },
